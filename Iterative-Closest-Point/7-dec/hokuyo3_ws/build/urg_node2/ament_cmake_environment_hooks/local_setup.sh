...
: ${AMENT_CURRENT_PREFIX:="/home/zalv/hokuyo3_ws/install/urg_node2"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/urg_node2/environment/library_path.sh"
