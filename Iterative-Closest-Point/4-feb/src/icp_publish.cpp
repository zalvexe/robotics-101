...
private:
    ...
    void laserCallback(const sensor_msgs::msg::LaserScan::SharedPtr msg)
    {
        ...
        if(icp.hasConverged()) RCLCPP_INFO(this->get_logger(), "ICP converged"); //converged = has found the transformation (rotation n translation) that aligns the source & target pointcloud
